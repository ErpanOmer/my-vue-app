    ...
    <div class="jobrad">
            ...
            <div class="centeral-content">
                <div>
                    <img class="pcHide"
                        ...
                        alt="">
                    <span class="u48DemiBold">JobRad – <br> lease company e-bikes <br class="mobileHide">from Urtopia</span>
                    <span class="u24Medium">Orders via JobRad also benefit from our Easter promotion: 300 euros and free
                        accessories. The
                        discount
                        will be deducted at checkout. You will receive the accessories separately. Act quickly!</span>
            ...
            <div class="centeral-content">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="u17Light">With urtopia’s ebike theft and damage insurance, you can ride your bike with
                            confidence knowing that you are fully protected against any potential accidents or
                            thefts.</div>
                    </div>
                    <div>
        ...
        <div class="works">
            <div class="centeral-content">
                ...
                <div>
                    ...
                    <div class="u20Medium">Please ensure that your employer has signed up with JobRad.</div>
                    <div class="u17Light">1. Click on the button or filling the form below to start your application with a
                        ...
                        the
                        JobRad portal, where you can view and confirm it. <br><br>3. The offer is then converted into an
                        order that
                        your employer and JobRad must review and approve. <br><br>4. Once it’s been approved by your
                        employer, your
                        bike will then be shipped once in stock. 5. Please be aware that accessories will be shipped
        ...
        <div class="calculator">
            <div class="centeral-content jobrad-bike-leasing-calculator"
                ...
                <iframe width="100%" src="https://bike-leasing-calculator.jobrad.org?genericObserve=true"></iframe>
            </div>
        </div>
        <div class="forms" id="forms">
            <div class="centeral-content">
                ...
                <form action="" method="post">
                    ...
                    <div class="item">
                        <div class="u24Medium">Street address<i>*</i></div>
                    ...
                    <div class="item">
                        <div class="u24Medium">Country/Region<i>*</i></div>
                        ...
                        <div class="mini-item">
                            <div>
                                ...
                                <select name="bike_size" required>
                                    <option value="">---</option>
                                    <option>M - Fit for 170-185 cm</option>
                                    <option>M - Fit for 170-185 cm</option>
                                    <option>L - Fit for 180-195 cm</option>
                                </select>
                            </div>
                            <div>
                    ...
                    <div class="item">
                        <div class="u24Medium">Accessories you would like<i>*</i></div>
                        <input type="text" name="accessories" placeholder="Example: Kickstand, fenders, eSIM" required>
                    </div>
                    <div class="item">
                        <div class="checkbox">
                    ...
                    <div class="item">
                        <div style="display: flex;">
                            <input class="my-button my-button-black" type="submit" value="Submit" />
                            <a class="my-button my-button-white" href="/pages/contactus">Contact us</a>
                        </div>
                    </div>
    ...
    const faqs = [
        {
            ...
            content: 'You are an employee: If your company already works with JobRad, you can order your cowboy today. If not, you can introduce your employer <a target="_blank" href="https://www.jobrad.org/kontakt.html">here<a/> at JobRad. <br><br> You are self-employed: You can certainly lease one or more cowboys for your company via JobRad. You can find more practical information <a target="_blank" href="https://www.jobrad.org/kontakt.html">here<a/> .'
        },
        {
        ...
        },
        {
            ...
            content: 'The first year is free. <br><br>To avoid not being able to use some advanced features after one year, it is recommended to add 2 years of eSIM service on Jobrad.<br><br> Outdoor 4G connectivity requires an active eSIM service to ensure constant connectivity and security on the go. It is required for many advanced smart features such as activity tracking, AI voice control, motion alerts, and OTA updates.'
        },
        {
