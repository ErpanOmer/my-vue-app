<template>
    <div
        class="background-image er-aspect-[5/1] er-text-white er-flex er-flex-col er-justify-center er-items-center er-font-base er-text-center mb:er-aspect-square er-px-12">
        <img src="https://cdn.shopify.com/s/files/1/0583/5810/4213/files/Group_21336.webp?v=1739850283" alt="">
        <div class="background-mask er-bg-black/60"></div>
        <h1 class="er-text-8xl mb:er-text-6xl er-text-white er-m-0">Are you interested?</h1>
    </div>
    <div class="er-max-w-screen-md er-mx-auto er-px-12 er-my-48 er-text-dark/80 text-size24">
        <p>
            <span>
                If you’re well-connected in the business, join us on an exciting adventure to expand the Urtopia sales
                network and build a strong brand together. By selling Urtopia e-bikes, you’ll earn generous commissions
                on every sale you bring in. <br><br>Interested in Urtopia products? Fill out the form below and send us
                your resume — we’ll reach out if there’s a match, and you’ll get the chance to enjoy the excitement and
                rewards of being part of a fast-growing company.
            </span>
        </p>
    </div>
    <form id="form"
        class="er-max-w-screen-md er-mx-auto er-px-12 er-my-48 er-text-dark/90 er-space-y-12 er-box-border er-flex er-flex-col er-overflow-hidden">
        <fieldset class="er-grid er-grid-cols-2 er-gap-12 er-space-y-6">
            <legend class="text-size24">You want to be:<span class="er-text-red-500">*</span></legend>
            <label for="dealers"
                ...
                <div class="er-flex er-flex-col er-items-end er-ml-6 er-flex-1 er-text-right">
                    <span class="text-size20 er-font-medium er-text-primary/90">Aspiring Dealers</span>
            ...
            <label for="sales_reps"
                ...
                <div class="er-flex er-flex-col er-items-end er-ml-6 er-flex-1 er-text-right">
                    <span class="text-size20 er-font-medium">Ambitious Sales Reps</span>
                    <svg xmlns="http://www.w3.org/2000/svg" height="36px" viewBox="0 -960 960 960" width="36px"
        ...
        <div class="er-grid er-grid-cols-2 er-gap-12">
            <fieldset class="er-flex er-flex-col er-space-y-6">
                <label for="firstname" class="text-size24">First name:<span class="er-text-red-500">*</span></label>
            ...
            <fieldset class="er-flex er-flex-col er-space-y-6">
                <label for="lastname" class="text-size24">Last name:<span class="er-text-red-500">*</span></label>
        ...
        <div class="er-grid er-grid-cols-2 er-gap-12">
            <fieldset class="er-flex er-flex-col er-space-y-6">
                <label for="email" class="text-size24">Email:<span class="er-text-red-500">*</span></label>
                <input type="email" id="email" name="email"
                    class="mb:er-text-2xl er-box-border er-font-base er-w-full er-border-2 er-border-dark/30 placeholder:er-text-black/15 er-border-solid er-rounded-xl er-text-dark/85 er-text-3xl er-p-4 focus:er-border-primary/80 focus-visible:er-border-primary/80 focus:er-ring-primary focus:er-shadow-primary"
                    required>
            </fieldset>
            <fieldset class="er-flex er-flex-col er-space-y-6">
                <label for="phonenumber" class="text-size24">Phone number:<span class="er-text-red-500">*</span></label>
        ...
        <div class="er-grid er-grid-cols-2 er-gap-12">
            <fieldset class="er-flex er-flex-col er-space-y-6">
                <label for="shopname" class="text-size24">Name of shop/store:<span
            ...
            <fieldset class="er-flex er-flex-col er-space-y-6">
                <label for="brand_scarried" class="text-size24">Brands carried:<span
                        class="er-text-red-500">*</span></label>
        ...
        <fieldset class="er-flex er-flex-col er-space-y-6">
                <label for="sales_estimate" class="text-size24">Sales estimate for 1st year (# of e-bikes) :<span
                        class="er-text-red-500">*</span></label>
        ...
        <fieldset class="er-flex er-flex-col er-space-y-6">
            <label for="address" class="text-size24">Shop Location:<span class="er-text-red-500">*</span></label>
            <input type="text" id="address" name="address"
                class="mb:er-text-2xl er-box-border er-font-base er-w-full er-border-2 er-border-dark/30 placeholder:er-text-black/15 er-border-solid er-rounded-xl er-text-dark/85 er-text-3xl er-p-4 focus:er-border-primary/80 focus-visible:er-border-primary/80 focus:er-ring-primary focus:er-shadow-primary"
                required>
        </fieldset>
        <fieldset class="er-flex er-flex-col er-space-y-6">
            <label for="website" class="text-size24">Website (optional):</label>
            <input type="text" id="website" name="website"
                class="mb:er-text-2xl er-box-border er-font-base er-w-full er-border-2 er-border-dark/30 placeholder:er-text-black/15 er-border-solid er-rounded-xl er-text-dark/85 er-text-3xl er-p-4 focus:er-border-primary/80 focus-visible:er-border-primary/80 focus:er-ring-primary focus:er-shadow-primary">
        </fieldset>
        <fieldset class="er-flex er-flex-col er-space-y-6">
            <label for="comments" class="text-size24">What else you want us to know (optional):</label>
            <input type="text" id="comments" name="comments"
                class="mb:er-text-2xl er-box-border er-font-base er-w-full er-border-2 er-border-dark/30 placeholder:er-text-black/15 er-border-solid er-rounded-xl er-text-dark/85 er-text-3xl er-p-4 focus:er-border-primary/80 focus-visible:er-border-primary/80 focus:er-ring-primary focus:er-shadow-primary">
        </fieldset>
        <fieldset
            class="er-flex er-flex-col er-space-y-6 er-relative !er-cursor-pointer er-overflow-hidden er-max-w-screen-md er-hidden">
            <label for="resume" class="text-size24">Resume upload:<span class="er-text-red-500">*</span></label>
    ...
    <div class="er-max-w-screen-md er-mx-auto er-px-12 er-my-48 er-text-dark/90 er-space-y-12 er-box-border er-flex-col er-overflow-hidden thankyou er-items-center er-justify-center er-text-center er-hidden">
        ...
        <h1 class="text-size60">Thank You!</h1>
        <p class="text-size18">
